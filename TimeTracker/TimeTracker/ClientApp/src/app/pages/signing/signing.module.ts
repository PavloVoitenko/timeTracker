 ...
 */
@NgModule({
  declarations: [SignInComponent, SignUpComponent, SigningFormComponent],
  imports: [RouterModule.forChild(routes), FormsModule, SharedModule, MatFormFieldModule, MatInputModule, MatButtonModule],
})
